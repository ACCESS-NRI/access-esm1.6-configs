...
## Inputs
The abrupt-4xCO2 configuration uses the same input files as the [piControl](/configs_experiments/configurations/piControl) other than the initial conditions, which are taken from the 100th restart from the piControl experiment.
